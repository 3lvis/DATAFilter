...
class Tests: XCTestCase {
    ...
    func testMapChangesA() {
        ...
        dataStack.performInNewBackgroundContext { backgroundContext in
            ...
            let JSONObjects = try! JSON.from("users.json", bundle: NSBundle(forClass: Tests.self)) as! NSArray
            var inserted = 0
            var updated = 0
    ...
    func testMapChangesB() {
        ...
        dataStack.performInNewBackgroundContext { backgroundContext in
            ...
            let before = DATAObjectIDs.objectIDsInEntityNamed("User", withAttributesNamed: "remoteID", context: backgroundContext)
            let JSONObjects = try! JSON.from("users2.json", bundle: NSBundle(forClass: Tests.self)) as! NSArray
            var inserted = 0
            var updated = 0
            var deleted = before.count
            DATAFilter.changes(JSONObjects, inEntityNamed: "User", localPrimaryKey: "remoteID", remotePrimaryKey: "id", context: backgroundContext, inserted: { objectJSON in
    ...
    func testMapChangesC() {
        ...
        dataStack.performInNewBackgroundContext { backgroundContext in
            ...
            let before = DATAObjectIDs.objectIDsInEntityNamed("User", withAttributesNamed: "remoteID", context: backgroundContext)
            let JSONObjects = try! JSON.from("users3.json", bundle: NSBundle(forClass: Tests.self)) as! NSArray
            var inserted = 0
            var updated = 0
            var deleted = before.count
            DATAFilter.changes(JSONObjects, inEntityNamed: "User", localPrimaryKey: "remoteID", remotePrimaryKey: "id", context: backgroundContext, inserted: { objectJSON in
    ...
    func testStringID() {
        ...
        dataStack.performInNewBackgroundContext { backgroundContext in
            ...
            let JSONObjects = try! JSON.from("note.json", bundle: NSBundle(forClass: Tests.self)) as! NSArray
    ...
    func testInsertOnly() {
        ...
        dataStack.performInNewBackgroundContext { backgroundContext in
            ...
            let before = DATAObjectIDs.objectIDsInEntityNamed("User", withAttributesNamed: "remoteID", context: backgroundContext)
            let JSONObjects = try! JSON.from("simple.json", bundle: NSBundle(forClass: Tests.self)) as! NSArray
            var inserted = 0
            var updated = 0
            var deleted = before.count
